...
import com.example.tuca.gasmap.Modulos.Example;
...
public class telaMapa extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Model_Town = new LatLng(-21.200026, -47.778937);
            ...
            public void onResponse(Response<Example> response, Retrofit retrofit) {
                ...
                try {
                    ...
                    for (int i = 0; i < response.body().getRoutes().size(); i++) {
                        ...
                        ShowDistanceDuration.setText("Distância:" + distance + ", Duração:" + time);
                    ...
                    Log.d("onResponse", "Ocorreu um erro.");
                    e.printStackTrace();
                }
            }
